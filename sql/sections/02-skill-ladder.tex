...
\begin{itemize}
    ...
    \begin{itemize}
        \item explain tradeoffs to developers and stakeholders (e.g., ''why this query is slow'', 
...
\begin{itemize}
    \item You can look at a slow query and propose 2--3 plausible causes and next steps 
    (plan, indexes, rewrite).
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item SQL injection threat model and prevention principles (from both SQL and application 
        sides)
    \end{itemize}
\end{itemize}
